...
export const API_REGISTRY = [
...

  {
    ...
    category : 'manga',
    provider : 'komiku',
    label    : 'Komiku (Indonesia)',
    baseUrl  : 'https://api.komiku.org',      // endpoint HTMX — bukan komiku.org
    endpoints: {
      search  : '/',                          // → /?post_type=manga&s={query}
      info    : 'https://komiku.org/manga/{slug}/',
      chapters: 'https://komiku.org/manga/{slug}/',
      read    : 'https://komiku.org/ch/{chapterSlug}/',
    },
    rateLimit: { requests: 30, window: 60 },
    timeout  : 20000,
    enabled  : true,
    tags     : ['indonesia', 'bahasa', 'manga', 'manhwa', 'manhua', 'htmx-scraper'],
  },
  {
    id       : 'manhwaindo',
    category : 'manhwa',
    ...
    endpoints: {
      search  : '/?s={query}',
      info    : '/series/{slug}/',
      chapters: '/series/{slug}/',           // chapter list ada di halaman yang sama
      read    : '/{chapterSlug}/',           // contoh: /only-i-have-an-ex-grade-summon-chapter-16/
    },
    rateLimit: { requests: 30, window: 60 },
    timeout  : 20000,
    enabled  : true,
    tags     : ['indonesia', 'bahasa', 'manhwa', 'korean', 'scraper'],
  },
...
/** Categories list */
export const CATEGORIES = ['anime', 'manga', 'manhwa', 'manhua', 'donghua'];
